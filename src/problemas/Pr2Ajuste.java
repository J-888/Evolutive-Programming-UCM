...
public class Pr2Ajuste extends Problema {
	...
	public Pr2Ajuste(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, boolean escalado, JFrame gui){
