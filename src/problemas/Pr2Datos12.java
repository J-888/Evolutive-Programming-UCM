...
public class Pr2Datos12 extends ProblemaFuncion {
	
	public Pr2Datos12(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, GraficaPanel chartPanel){
		this.funcSelec = funcSelec;
		this.funcMuta = funcMuta;
		this.funcCruz = funcCruz;
		this.rangoVar = new ArrayList<Par<Double>>();
		this.rangoVar.add(new Par<Double>((double)DatosMatrices.getMatrixDim("datos12") , (double)DatosMatrices.getMatrixDim("datos12")));
