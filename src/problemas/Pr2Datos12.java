...
public class Pr2Datos12 extends Problema {
	...
	public Pr2Datos12(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, boolean escalado, boolean inversionEspecial, JFrame gui){
