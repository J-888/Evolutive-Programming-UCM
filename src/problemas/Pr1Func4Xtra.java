...
public class Pr1Func4Xtra extends Problema{
	...
	public Pr1Func4Xtra(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, boolean escalado, boolean inversionEspecial, JFrame gui, int n){
		super(funcCruz, funcMuta, funcSelec, elite0to1, numGenerations, tamPob, n, escalado, inversionEspecial, gui);
