...
public class Pr2Datos30 extends ProblemaFuncion {
	...
	public Pr2Datos30(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, GraficaPanel chartPanel){
		...
		this.funcFit = new FitnessPr2("datos30");
