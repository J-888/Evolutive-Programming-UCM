...
public class Pr2Datos30 extends Problema {
	...
	public Pr2Datos30(FuncionCruce funcCruz, FuncionMutacion funcMuta, FuncionSeleccion funcSelec, double elite0to1, int numGenerations, int tamPob, boolean escalado, boolean inversionEspecial, JFrame gui){
		super(funcCruz, funcMuta, funcSelec, elite0to1, numGenerations, tamPob, 1, escalado, inversionEspecial, gui);
		
		this.rangoVar.add(new Par<Double>((double)DatosMatrices.getMatrixDim("datos30") , (double)DatosMatrices.getMatrixDim("datos30"))); //reminder to update rangoSize on super constructor s
		this.minimizacion = true;
		this.funcFit = new FitnessPr2("datos30", this.minimizacion);
