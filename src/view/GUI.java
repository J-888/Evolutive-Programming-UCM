...
public class GUI extends JFrame{
	...
	private FuncionCruce[] crossoverOptionsBin = {new Monopunto(), new Multipunto(2), new Multipunto(3)}; 
	private FuncionCruce[] crossoverOptionsReal = {new Monopunto(), new Aritmetico()};
	private FuncionCruce[] crossoverOptionsPermInt = {new PMX(), new OX(), new OXPosPrio(), new OXOrdenPrio(), new CX(), new ERX(), new Monopunto(), new Multipunto(2), new Multipunto(3)};
